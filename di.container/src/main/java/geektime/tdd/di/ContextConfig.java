...
public class ContextConfig {
    ...
    class ConstructorInjectionProvider<T> implements ComponentProvider<T> {
        ...
        public T get(Context context) {
            if (constructing) throw new CyclicDenpendenciesFoundException(componentType);
            try {
                constructing = true;
            ...
            }  catch (CyclicDenpendenciesFoundException e) {
                throw new CyclicDenpendenciesFoundException(componentType, e);
