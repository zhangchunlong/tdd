    ...
    public class ConstructorInjection {
        ...
        class Injection {
            ...
            public void should_inject_dependency_via_inject_constructor() {
                InjectorConstructor instance = new ConstructorInjectionProvider<>(InjectorConstructor.class).get(context);
            ...
            public void should_include_dependency_from_inject_constructor() {
                ConstructorInjectionProvider<InjectorConstructor> provider = new ConstructorInjectionProvider<>(InjectorConstructor.class);
        ...
        class IllegalInjectConstructors {
            ...
            public void should_throw_exception_if_no_inject_nor_default_constructor_provided() {
                assertThrows(IllegalComponentException.class, () -> {
                    new ConstructorInjectionProvider<>(NoInjectConstructorNorDefaultConstructor.class);
                });
            }
        }
    }
